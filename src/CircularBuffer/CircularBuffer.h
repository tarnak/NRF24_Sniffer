...
portMUX_TYPE _privateMux = portMUX_INITIALIZER_UNLOCKED;
#define DISABLE_IRQ portENTER_CRITICAL_ISR(&_privateMux)
#define RESTORE_IRQ portEXIT_CRITICAL_ISR(&_privateMux)
#else
